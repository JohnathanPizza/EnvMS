// Turbidity Sensor
// Author: Timothy Strawn, MOD Zahid
// Edited Last: 4/3/25

// Turbidity is a measure of how cludy your water is. If it's too cloudy, that represents potential contaminants

// Pins
#define turbiditySensor A0
const int LEDg = 10;
const int LEDo = 8;
const int LEDy = 6;
const int LEDr = 4;
